...
private:
    ...
    void loadiCDFs() {
        ...
        //std::string basePath = ResolveFilename("../../precompiled_fsd_tables");
        //std::string basePath = "../../precompiled_fsd_tables";
        //std::string basePath =
        //    "D:/Coding/Github-Repo/Diffraction-Simulation/"
        //    "precompiled_fsd_tables";
        
        std::string basePath(CMAKE_SOURCE_DIR_PATH);
        basePath = basePath + "/precompiled_fsd_tables";
...
FsdMaterial *CreateFsdMaterial(const TextureParams &mp,
                               const std::shared_ptr<Material> &material) {

    std::shared_ptr<Texture<Spectrum>> scale =
        mp.GetSpectrumTexture("scale", Spectrum(1.0f));
